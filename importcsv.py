...
django.setup()
from product.models import Menus
...
from product.models import ProductsMainImages
...
from product.models import Hashtags
...
from product.models import ProductAndHashtag
...
with open(CSV_PATH_PRODUCTS) as in_file :
    ...
    next(data_reader, None)
    for row in data_reader :
        ProductAndHashtag.objects.create(
            product_id = row[1],
            hashtag_id = row[2]
            )